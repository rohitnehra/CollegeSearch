...
fs.readFile("../MERGED2016_17_PP.csv", 'utf8', function (err, data) {
    if (err) console.log(err);
        ...
        for (let i = 1; i < colleges.length; i++) {
            ...
            for (let x = 4; x < key.length; x++) {
                //console.log(key[x])
                if (college[x] == 'NULL' || college[x] == 'PrivacySuppressed') college[x] = null;
                //Add special thing for "ASSOC" and "BACHL" cuz i don't wanna type all that out
