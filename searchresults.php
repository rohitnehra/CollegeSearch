            ...
            $.getJSON("CollegeFind.json", function (colleges) {    
                ...
                colleges.forEach(college => {
                    if (college.INSTNM.toLowerCase().includes(searchedCollege.toLowerCase())) {
                        ...
                        if (college.TRIBAL) AddTextElement("This college is a tribal college", storeCollege)
                        if (college.NANTI) AddTextElement("This is a Native American non-triabl college", storeCollege)
                        if (college.MENONLY) AddTextElement("This is a men-only college", storeCollege)
                        if (college.WOMENONLY) AddTextElement("This is a women-only college", storeCollege)
                        ...
                        if (college.NPCURL) {
                            storeCollege.appendChild(document.createTextNode("Net price calculator: "))
                            const newElement = document.createElement("a");
                        ...
                        if (college.CONTROL) {
                            switch (college.CONTROL) {
                                case 1:
                                    ...
                                    break;
                                case 2: 
                                    AddTextElement("This is a private nonprofit college", storeCollege)
                                    break;
                                case 3:
                                    AddTextElement("This is a private for-profit college", storeCollege)
                                    break;
                        ...
                        if (college.ST_FIPS) {
                            switch (college.ST_FIPS) {
                                case 11:
                                    AddTextElement("Located in the District of Columbia", storeCollege)
                                    break;
                                case 60:
                                    AddTextElement("Located in American Samoa", storeCollege)
                                    break;
                                case 64:
                                    AddTextElement("Located in the Federated States of Micronesia", scoreCollege)
                                    break;
                                case 66:
                                    AddTextElement("Located in Guam", storeCollege)
                                    break;
                                case 69:
                                    AddTextElement("Located in Northern Mariana Islands", storeCollege)
                                    break;
                                case 70:
                        ...
                        if (college.REGION) {
                            switch (college.REGION) {
                                case 1:
                                    AddTextElement("Located in the region of New England (CT, ME, MA, NH, RI, VT)", storeCollege)
                                    break;
                                case 2:
                                    AddTextElement("Located in the region of the Mid East (DE, DC, MD, NJ, NY, PA)", storeCollege)
                                    break;
                                case 3:
                                    AddTextElement("Located in the region of the Great Lakes (IL, IN, MI, OH, WI)", storeCollege)
                                    break;
                                case 4:
                                    AddTextElement("Located in the region of the Plains (IA, KS, MN, MO, NE, ND, SD)", storeCollege)
                                    break;
                                case 5:
                                    AddTextElement("Located in the Southeast (AL, AR, FL, GA, KY, LA, MS, NC, SC, TN, VA, WV)", storeCollege)
                                    break;
                                case 6:
                                    AddTextElement("Located in the Southwest (AZ, NM, OK, TX)", storeCollege)
                                    break;
                                case 7:
                                    AddTextElement("Located by the Rocky Mountains (CO, ID, MT, UT, WY)", storeCollege)
                                    break;
                                case 8:
                                    AddTextElement("Located in the Far West (AK, CA, HI, NV, OR, WA)", storeCollege)
                                    break;
                                case 9:
                                    AddTextElement("Located in the Outlying Areas (AS, FM, GU, MH, MP, PR, PW, VI)", storeCollege)
                                    break;
                        ...
                        if (college.LOCALE) {
                            switch (college.LOCALE) {
                                case 11:
                                    AddTextElement("This college is located in a large city (population of 250,000 or more)", storeCollege)
                                    break;
                                case 12:
                                    AddTextElement("This college is located in a midsized city (population of at least 100,000 but less than 250,000)", storeCollege)
                                    break;
                                case 13:
                                    AddTextElement("This college is located in a small city (population less than 100,000)", storeCollege)
                                    break;
                                case 21:
                                    AddTextElement("This college is located in a large suburb (outside principal city, in urbanized area with population of 250,000 or more)", storeCollege)
                                    break;
                                case 22:
                                    AddTextElement("This college is located in a midsized suburb (outside principal city, in urbanized area with population of at least 100,000 but less than 250,000)", storeCollege)
                                    break;
                                case 23:
                                    AddTextElement("This college is located in a small suburb (outside principal city, in urbanized area with population less than 100,000)", storeCollege)
                                    break;
                                case 31:
                                    AddTextElement("This college is located in a frige town (in urban cluster up to 10 miles from an urbanized area)", storeCollege)
                                    break;
                                case 32:
                                    AddTextElement("This college is located in a distant town (in urban cluster more than 10 miles and up to 35 miles from an urbanized area)", storeCollege)
                                    break;
                                case 33:
                                    AddTextElement("This college is located in a remote town (in urban cluster more than 35 miles from an urbanized area)", storeCollege)
                                    break;
                                case 41:
                                    AddTextElement("This college is located in a frige rural area (rural territory up to 5 miles from an urbanized area or up to 2.5 miles from an urban cluster)", storeCollege)
                                    break;
                                case 42:
                                    AddTextElement("This college is located in a distant rural area (rural territory more than 5 miles but up to 25 miles from an urbanized area or more than 2.5 and up to 10 miles from an urban cluster)", storeCollege)
                                    break;
                                case 43: 
                                    AddTextElement("This college is located in a remote rural area (rural territory more than 25 miles from an urbanized area and more than 10 miles from an urban cluster)", storeCollege)
                                    break;
                            }
                        }
                        ...
                        if (college.CCBASIC) {
                            switch (college.CCBASIC) {
                                case 1:
                                    ...
                                    break;
                                case 2:
                                    AddTextElement("High Transfer-Mixed Traditional/Nontraditional", storeCollege)
                                    break;
                                case 3:
                                    AddTextElement("High Transfer-High Nontraditional", storeCollege)
                                    break;
                                case 4:
                                    AddTextElement("Mixed Transfer/Vocational & Technical-High Traditional", storeCollege)
                                    break;
                                case 5:
                                    AddTextElement("Mixed Transfer/Vocational & Technical-Mixed Traditional/Nontraditional", storeCollege)
                                    break;
                                case 6:
                                    AddTextElement("Mixed Transfer/Vocational & Technical-High Nontraditional", storeCollege)
                                    break;
                                case 7:
                                    AddTextElement("High Vocational & Technical-High Traditional", storeCollege)
                                    break;
                                case 8:
                                    AddTextElement("High Vocational & Technical-Mixed Traditional/Nontraditional", storeCollege)
                                    break;
                                case 9:
                                    AddTextElement("High Vocational & Technical-High Nontraditional", storeCollege)
                                    break;
                                case 10:
                        ...
                        if (college.CCUGPROF) {
                            switch (college.CCUGPROF) {
                                ...
                                case 5:
                                    ...
                                    break;
                                case 6:
                                    AddTextElement("medium full-time, inclusive, lower transfer-in", storeCollege)
                                    break;
                                case 7:
                                    AddTextElement("medium full-time, inclusive, higher transfer-in", storeCollege)
                                    break;
                                case 8:
                                    AddTextElement("medium full-time, selective, lower transfer-in", storeCollege)
                                    break;
                                case 9:
                                    AddTextElement("medium full-time , selective, higher transfer-in", storeCollege)
                                    break;
                                case 10:
                                    AddTextElement("full-time, inclusive, lower transfer-in", storeCollege)
                                    break;
                                case 11:
                                    AddTextElement("full-time, inclusive, higher transfer-in", storeCollege)
                                    break;
                                case 12:
                                    AddTextElement("full-time, selective, lower transfer-in", storeCollege)
                                    break;
                                case 13:
                                    AddTextElement("full-time, selective, higher transfer-in", storeCollege)
                                    break;
                                case 14:
                                    AddTextElement("full-time, more selective, lower transfer-in", storeCollege)
                                    break;
                                case 15:
                                    AddTextElement("full-time, more selective, higher transfer-in", storeCollege)
                                    break;
                            }
                        }
                        if (college.CCSIZSET) {
                            switch (college.CCSIZSET) {
                                ...
                                case 5:
                                    ...
                                    break;
                                case 6:
                                    AddTextElement("very small, primarily nonresidential", storeCollege)
                                    break;
                                case 7:
                                    AddTextElement("very small, primarily residential", storeCollege)
                                    break;
                                case 8:
                                ...
                                case 17:
                                    ...
                                    break;
                                case 18:
                                    AddTextElement("Exclusively graduate/professional", storeCollege)
                                    break;
                            }
                        }
                        if (college.HBCU) AddTextElement("This college is a historically black college", storeCollege)
                        if (college.PBI) AddTextElement("This college is predominantly black", storeCollege)
                        if (college.ANNHI) AddTextElement("This college serves Alaska Natives and Native Hawaiians", storeCollege)
                        if (college.AANAPII) AddTextElement("This college serves Asian American Natives and American Pacific Islanders", storeCollege)
                        if (college.HSI) AddTextElement("This college serves hispanics", storeCollege)

                        if (college.RELAFFIL) {
                            switch (college.RELAFFIL) {
                                case 22:
                                    AddTextElement("American Evangelical Lutheran Church", storeCollege)
                                    break;
                                case 24:
                                    AddTextElement("African Methodist Episcopal Zion Church", storeCollege)
                                    break;
                                case 27:
                                ...
                                case 30:
                                    ...
                                    break;
                                case 33:
                                    AddTextElement("Wisconsin Evangelical Lutheran Synod", storeCollege)
                                    break;
                                case 34:
                                    AddTextElement("Christ and Missionary Alliance Church", storeCollege)
                                    break;
                                case 35:
                                    AddTextElement("Christian Reformed Church", storeCollege)
                                    break;
                                case 36:
                                    AddTextElement("Evangelical Congregational Church", storeCollege)
                                    break;
                                case 37:
                                    AddTextElement("Evangelical Covenant Church of America", storeCollege)
                                    break;
                                case 38:
                                    AddTextElement("Evangelical Free Church of America", storeCollege)
                                    break;
                                case 39:
                                    AddTextElement("Evangelical Lutheran Church", storeCollege)
                                    break;
                                case 40:
                                    AddTextElement("International United Pentecostal Church", storeCollege)
                                    break;
                                case 41:
                                ...
                                case 47:
                                    ...
                                    break;
                                case 48:
                                    AddTextElement("Christian Churches and Churches of Christ", storeCollege)
                                    break;
                                case 49:
                                    AddTextElement("Christian Churches and Churches of Christ", storeCollege)
                                    break;
                                ...
                                case 60:
                                    ...
                                    break;
                                case 61:
                                    AddTextElement("Christian Church (Disciples of Christ)", storeCollege)
                                    break;
                                case 64:
                                ...
                                case 93:
                                    ...
                                    break;
                                case 94:
                                    AddTextElement("Latter Day Saints (Mormon Church)", storeCollege)
                                    break;
                                case 95:
                                    AddTextElement("Seventh Day Adventists", storeCollege)
                                    break;
                                case 97:
                                    AddTextElement("The Presbyterian Church in America", storeCollege)
                                    break;
                                case 99:
                        ...
                        if (college.ADM_RATE) AddTextElement(`This college has an admissions rate of ${college.ADM_RATE * 100}%`, storeCollege)
