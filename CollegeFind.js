...
fs.readFile("./MERGED2016_17_PPFIXED.csv", 'utf8', function (err, data) {
    if (err) console.log(err);
        ...
        fs.writeFile("CollegeFind.json", JSON.stringify(allColleges), err => {
            if (err) console.log(err)
            else ("DONE")
        })
    }
